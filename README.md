...
| Command       | Description                                        |
|---------------|----------------------------------------------------|
| `ams s`       | Shows status, time left, and whether the display can sleep. |
...
This workflow is based on the [AppleScript Documentation: Amphetamine | Toothpicks Support Portal](https://iffy.freshdesk.com/support/solutions/articles/48000078223-applescript-documentation).
